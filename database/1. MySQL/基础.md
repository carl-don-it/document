...
3. https://www.kancloud.cn/thinkphp/mysql-design-optimalize/39325 | 字段类型与合理的选择字段类型 · Mysql设计与优化专题 · 看云
   https://www.jianshu.com/p/7fe85454a4f4 | varchar类型的长度怎么确定？有什么样的原则，和Text和LongText的区别是什么？ - 简书
   https://www.jianshu.com/p/7e60dbd59138 | 数据库设计中的命名规范 - 简书
   https://www.jianshu.com/p/85ab7482595b | 团队开发规范V0.7，不断更新中 - 简书
...
————————————————
版权声明：本文为CSDN博主「javartisan」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/Dax1n/article/details/86581472
**/
set sql_mode ='STRICT_TRANS_TABLES,ONLY_FULL_GROUP_BY,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';

```

https://blog.csdn.net/Dax1n/article/details/86581472
...
(6) WITH {CUBE | ROLLUP}  -- <深入浅出 page 325>
...
## 参考文献
 ...
 [终于卷完了！MySQL 打怪升级进阶成神之路（2023 最新版）！](https://mp.weixin.qq.com/s?__biz=MzI0MDQ4MTM5NQ==&mid=2247537464&idx=2&sn=e1c3aab270ee81d045584a10dcbe788b&chksm=e9183624de6fbf3255c6810f3c572ee4ea411d65bccf19c61e4ff98f32faf809e1f92a774618&scene=21#wechat_redirect |)
[终于卷完了！MySQL 打怪升级进阶成神之路（2023 最新版）！ - 民工哥 - 博客园](https://www.cnblogs.com/youkanyouxiao/p/17946969 | )
